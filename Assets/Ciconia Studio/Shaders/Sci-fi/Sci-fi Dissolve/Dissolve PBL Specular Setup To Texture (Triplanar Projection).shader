Shader "Ciconia Studio/Effects/Sci-Fi/Dissolve/Specular Setup/Dissolve To Texture (Triplanar Projection)" {
    Properties {
...
///////// Gloss:
                ...
                float Glossiness = lerp((_SpecGlossMap_var.a*_Glossiness),(_SpecularmapGlossA2_var.a*_Glossiness2),Mask);
...
/////// Diffuse:
                ...
                float Ambientlight = lerp(_Ambientlight,_Ambientlight2,Mask);
                ...
                float Aomap = lerp(saturate((1.0-(1.0-_OcclusionMap_var.r)*(1.0-lerp(1,0,_AoIntensity)))),saturate((1.0-(1.0-_AmbientOcclusionmap2_var.r)*(1.0-lerp(1,0,_AoIntensity2)))),Mask);
