Shader "Ciconia Studio/Effects/Sci-Fi/Dissolve/Specular Setup/Dissolve To Color (UV Projection)" {
    Properties {
...
///////// Gloss:
                ...
                float node_2657 = (_SpecGlossMap1.a*_Glossiness);
                float4 _SpecularmapGlossA2 = tex2D(_SpecGlossMap,TRANSFORM_TEX(i.uv0, _SpecGlossMap));
                float node_7095 = (_SpecularmapGlossA2.a*_Glossiness2);
